// // Importer les codes d'erreurs Firebase, si nécessaire.
// import { AuthErrorCodes } from 'firebase/auth';

// type FirebaseErrorMessages = { [key: string]: string };

// const firebaseErrorMessages: FirebaseErrorMessages = {
//   [AuthErrorCodes.INVALID_EMAIL]: "L'adresse email est invalide.",
//   //   [AuthErrorCodes.MISSING_PASSWORD]: 'Le mot de passe est requis.',
